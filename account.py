...
def reg():
    ...
    my_canvas.create_text(400, 60, text="CREATE AN ACCOUNT", font=("arial",30,'bold'), fill="black")
    ...
    name_entry = Entry(root, bd=0.5, bg="black", fg="white", font=("cambria", 22, 'italic'), insertbackground="black")
